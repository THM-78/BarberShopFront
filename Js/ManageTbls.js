...
function getAllService(){
  ...
  $.ajax({
      url:'https://localhost:44342/api/Reservation/AllServices',
      type:'GET',
      dataType:'json',
...
function getAllHairStylist(){
  $.ajax({
    url:'https://localhost:44342/api/Reservation/AllHairStylists',
    type:'GET',
    dataType:'json',
    contentType:'application/json',
    success: function(data){
...
function EditStylist(t){
  ...
  $.ajax({
    url:`https://localhost:44342/api/Admin/StylistById/${id}`,
    type:'GET',
    dataType:'json',
    contentType:'application/json',
    success: function(data){
  ...
  $.ajax({
      url:`https://localhost:44342/api/Admin/AllStylistLevels`,
      type:'GET',
      dataType:'json',
      contentType:'application/json',
      success: function(data){
...
function EditStylistSave(t){
  ...
  $.ajax({
    url: `https://localhost:44342/api/Admin/EditStylist`,
    type:'POST',
...
function DeleteStylistSave(t){
  ...
  console.log(id)
  $.ajax({
    url: `https://localhost:44342/api/Admin/DelStylist/${id}`,
    type: 'DELETE',
    contentType: 'application/json',
    success: function(data){
...
function getAllDiscodes(){
  ...
  $.ajax({
    url:'https://localhost:44342/api/Admin/AllDiscountCode',
    type:'GET',
    dataType:'json',
    contentType:'application/json',
    success: function(data){
...
function AddDiscodeSave(){
  ...
  if(percent.value == '' || percent.value.trim().length > 3 || isNaN(percent.value) == true){
    ...
    $.ajax({
      url: `https://localhost:44342/api/Admin/AddDiscode`,
      type: 'POST',
      contentType: 'application/json',
...
function EditDiscode(t){
  var id= t.id.substring(12).trim();
  $.ajax({
    url: `https://localhost:44342/api/Admin/DiscodeById/${id}`,
    type: 'GET',
    contentType: 'application/json',
    success: function(data){
...
function DeleteDiscodeSave(t){
  ...
  $.ajax({
    url: `https://localhost:44342/api/Admin/DelDiscode/${id}`,
    type: 'DELETE',
    contentType: 'application/json',
    success: function(data){
...
function getSuggestions(PageNo){
  $.ajax({
    url: `https://localhost:44342/api/Admin/AllSuggestion/${PageNo}`,
    type:'GET',
    dataType:'json',
    contentType:'application/json',
    success: function(data){
...
function getAllBeforeAfterImg(){
  $.ajax({
    url:'https://localhost:44342/api/Admin/AllBeforeAfterImg',
    type:'GET',
    dataType:'json',
    contentType:'application/json',
    success: function(data){
...
function AddServiceSave(){
  ...
  if(AddServiceTime.value == '' || AddServiceTime.value.trim().length > 3 || isNaN(AddServiceTime.value) == true){
    ...
    $.ajax({
      url: `https://localhost:44342/api/Admin/AddService`,
      type: 'POST',
      contentType: 'application/json',
...
function EditService(t){
  ...
  var id = t.id.substring(12).trim()
  $.ajax({
    url:`https://localhost:44342/api/Admin/ServiceById/${id}`,
    type:'GET',
    dataType:'json',
    contentType:'application/json',
    success: function(data){
...
function EditServiceSave(t){
  ...
  if(EditTime.value.trim() == '' || isNaN(EditTime.value) == true || EditTime.value.length > 3){
    ...
    $.ajax({
      url: `https://localhost:44342/api/Admin/EditService`,
      type: 'POST',
      contentType: 'application/json',
...
function DeleteServiceSave(t){
  ...
  $.ajax({
    url: `https://localhost:44342/api/Admin/DelService/${id}`,
    type: 'DELETE',
    contentType: 'application/json',
    success: function(data){
...
function ViewSuggestion(t){
  ...
  $.ajax({
    url: `https://localhost:44342/api/Admin/SuggestionTextById/${id}`,
    type:'GET',
    dataType:'json',
    contentType:'application/json',
    success: function(data){
      document.getElementById('suggestion-view-text').innerHTML = data.message
    },
    error: function(){
      console.log('error')
    }
...
function DeleteSuggestionSave(t){
  var id = t.id.substring(6).trim();
  $.ajax({
    url: `https://localhost:44342/api/Admin/DelSuggestion/${id}`,
    type: 'DELETE',
    contentType: 'application/json',
    success: function(data){
...
function AddBeforeAfterSave(){
  ...
  if(afterImg.value == ''){
    ...
    $.ajax({
      url: `https://localhost:44342/api/Admin/AddBeforeAfterImg`,
      type:'POST',
...
function EditBeforeAfter(t){
  ...
  $.ajax({
    url: `https://localhost:44342/api/Admin/BeforeAfterById/${id}`,
    type:'GET',
    dataType:'json',
    contentType:'application/json',
    success: function(data){
...
function EditBeforeAfterSave(t){
  ...
  if(afterImg.value == ''){
    ...
    $.ajax({
      url: `https://localhost:44342/api/Admin/EditBeforeAfterImg`,
      type:'POST',
...
function DeleteBeforeAfterSave(t){
  ...
  $.ajax({
    url: `https://localhost:44342/api/Admin/DelBeforeAfterImg/${id}`,
    type:'DELETE',
    contentType:'application/json',
    success: function(data){
